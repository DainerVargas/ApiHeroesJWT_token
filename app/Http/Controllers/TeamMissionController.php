...
class TeamMissionController extends Controller
{
    public function index()
    {
        $superheroes = TeamMission::all();
    ...
    public function store(Request $request)
    {
        ...
        if ($validate) {
            $superheroes = TeamMission::create($request->all());
            return response()->json($superheroes);
        }else{
    ...
    {
        $superheroes = TeamMission::findOrFail($id);
